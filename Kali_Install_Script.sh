...
wget https://github.com/danielmiessler/SecLists/blob/master/Discovery/Web-Content/weblogic.txt -O /usr/share/wordlists/SecLists/Discovery/Web_Content/weblogic.txt
