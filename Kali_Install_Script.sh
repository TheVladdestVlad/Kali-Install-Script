...
wget https://raw.githubusercontent.com/danielmiessler/SecLists/master/Discovery/Web-Content/IIS.fuzz.txt -O /usr/share/wordlists/SecLists/Discovery/Web_Content/IIS.fuzz.txt
wget https://raw.githubusercontent.com/danielmiessler/SecLists/master/Discovery/Web-Content/weblogic.txt -O /usr/share/wordlists/SecLists/Discovery/Web_Content/weblogic.txt
wget https://raw.githubusercontent.com/random-robbie/bruteforce-lists/master/api.txt -O /usr/share/wordlists/SecLists/Discovery/Web_Content/api.txt
...
echo "-----https://github.com/gwen001/s3-buckets-finder     ----------------"
